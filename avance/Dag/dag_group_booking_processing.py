...
spark_job = DataProcPySparkOperator(
    task_id='spark_job',
    main='gs://it-analytics-inventory-387221-dev/processing_resources/spark_processing.py',
    job_name='spark-job-processing',
    cluster_name='dev-group-booking-387221',
    region='us-central1',
    dag=dag
)
...
gcs_to_bigquery = PythonOperator(
    ...
    op_kwargs={
        'bucket_name': 'it-analytics-inventory-387221-dev',
        ...
        'project_id': 'impressive-kite-387221',
        'dataset_id': 'booking'
    },
    dag=dag
)
