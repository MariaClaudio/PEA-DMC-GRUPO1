...
# b. Define file path
gcs_file_path = "gs://it-analytics-inventory-387221-dev/datalake/workload/group_booking_request/group_booking_request.csv"
...
gcs_destination_path = "gs://it-analytics-inventory-387221-dev/datalake/landing/group_booking_request/"
...
# b. Define file path
gcs_file_path = "gs://it-analytics-inventory-387221-dev/datalake/workload/group_booking_request_movement/group_booking_request_movement.csv"
...
# Save dataframe to a Landing layer path
gcs_destination_path = "gs://it-analytics-inventory-387221-dev/datalake/landing/group_booking_request_movement/"
...
# b. Define file path
gcs_file_path = "gs://it-analytics-inventory-387221-dev/datalake/workload/external_sources/airports.csv"

# c. Load data
df_airport = spark.read.format("CSV").option("header","true").option("delimiter",",").schema(df_schema).load(gcs_file_path)

# Save dataframe to a Landing layer path
gcs_destination_path = "gs://it-analytics-inventory-387221-dev/datalake/landing/external_sources/"
...
# Define file path
gcs_landing_path = "gs://it-analytics-inventory-387221-dev/datalake/landing/group_booking_request/"
...
gcs_curated_group_booking_request_path = "gs://it-analytics-inventory-387221-dev/datalake/curated/group_booking_request/"
...
# Define file path
gcs_landing_path = "gs://it-analytics-inventory-387221-dev/datalake/landing/group_booking_request_movement/"
...
# Define destination path in curated layer
gcs_curated_group_booking_request_movement_path = "gs://it-analytics-inventory-387221-dev/datalake/curated/group_booking_request_movement/"
...
# Define file path
gcs_landing_path = "gs://it-analytics-inventory-387221-dev/datalake/landing/external_sources/"
...
# Define destination path in curated layer
gcs_curated_airport_path = "gs://it-analytics-inventory-387221-dev/datalake/curated/external_sources"
...
gcs_curated_group_booking_request = "gs://it-analytics-inventory-387221-dev/datalake/curated/group_booking_request/"
gcs_curated_group_booking_request_movement = "gs://it-analytics-inventory-387221-dev/datalake/curated/group_booking_request_movement/"
gcs_curated_airport = "gs://it-analytics-inventory-387221-dev/datalake/curated/external_sources/"
...
path_group_booking_functional =  "gs://it-analytics-inventory-387221-dev/datalake/functional/group_booking/"
